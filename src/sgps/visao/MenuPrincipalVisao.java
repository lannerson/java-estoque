...
public class MenuPrincipalVisao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        miCadAnimal.setText("Manutenção de Animal");
        ...
        miCadUsuario.setText("Cadastro de Usuário");
    ...
    private void miCadUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miCadUsuarioActionPerformed
         try {
            if (VerificaFrame.verificaFrame(dpPrincipal, usuarioCadastroVisao) != true) {
                usuarioCadastroVisao = new UsuarioCadastroVisao();
                dpPrincipal.add(usuarioCadastroVisao);
            } else {
                usuarioCadastroVisao.setIcon(false);
            }
            usuarioCadastroVisao.setVisible(true);
        } catch (Exception ey) {
            ey.printStackTrace();
        }
    ...
    UsuarioCadastroVisao usuarioCadastroVisao;
}
