...
public class Contaspagar implements Serializable {
    ...
    @JoinColumn(name = "IDTIPOMOVFINANCEIROCP", referencedColumnName = "IDTIPOMOVFINANCEIRO")
    ...
    @JoinColumn(name = "IDPESSOAFORNECEDORCP", referencedColumnName = "IDPESSOAFORNECEDOR")
    @ManyToOne(optional = false)
