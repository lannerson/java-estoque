 ...
 */
@Entity
@Table(name = "ACESSOUSUARIO", catalog = "sgps", schema = "")
@NamedQueries({
...
public class Acessousuario implements Serializable {
    ...
    @Column(name = "CODIGOTIPOACESSO", nullable = false)
    ...
    @JoinColumn(name = "IDTELASISTEMA", referencedColumnName = "IDTELASISTEMA", nullable = false, insertable = false, updatable = false)
    @ManyToOne(optional = false)
