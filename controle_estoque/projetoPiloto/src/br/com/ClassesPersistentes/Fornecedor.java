...
public class Fornecedor implements Serializable {
    ...
    @Column(name = "RG_FORNECEDOR", length = 25)
    private String rgFornecedor;
    @Column(name = "ORGAO_RG_FORNECEDOR", length = 10)
    ...
    @Column(name = "ENDERECO_FORNECEDOR", length = 100)
    private String enderecoFornecedor;
    @Column(name = "BAIRRO_FORNECEDOR", length = 50)
    private String bairroFornecedor;
    @Column(name = "CIDADE_FORNECEDOR", length = 50)
    private String cidadeFornecedor;
    @Column(name = "UF_FORNECEDOR", length = 2)
    private String ufFornecedor;
    @Column(name = "CEP_FORNECEDOR", length = 8)
    private String cepFornecedor;
    @Column(name = "EMAIL_FORNECEDOR", length = 100)
    private String emailFornecedor;
    @Column(name = "SITE_FORNECEDOR", length = 100)
    private String siteFornecedor;
    @Column(name = "FONE_FORNECEDOR", length = 10)
    private String foneFornecedor;
    @Column(name = "CELULAR_FORNECEDOR", length = 10)
    private String celularFornecedor;
    @Column(name = "FAX_FORNECEDOR", length = 10)
    private String faxFornecedor;
    @Column(name = "CONTATO_FORNECEDOR", length = 50)
    ...
    public String toString() {
        return "br.com.ClassesPersistentes.Fornecedor[codFornecedor=" + codFornecedor + "]";
    }
