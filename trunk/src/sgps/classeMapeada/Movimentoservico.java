...
public class Movimentoservico implements Serializable {
    ...
    @JoinColumn(name = "IDVENDAMOVSERVICO", referencedColumnName = "IDVENDA")
    ...
    @JoinColumn(name = "IDSERVICOMOVSERVICO", referencedColumnName = "IDSERVICO")
    @ManyToOne(optional = false)
