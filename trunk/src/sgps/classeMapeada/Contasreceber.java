...
public class Contasreceber implements Serializable {
    ...
    @JoinColumn(name = "IDTIPOMOVFINANCEIROCR", referencedColumnName = "IDTIPOMOVFINANCEIRO")
    @ManyToOne(optional = false)
    private Tipomovimentofinanceiro idtipomovfinanceirocr;
    @JoinColumn(name = "IDPESSOACLIENTECR", referencedColumnName = "IDPESSOACLIENTE")
    @ManyToOne(optional = false)
