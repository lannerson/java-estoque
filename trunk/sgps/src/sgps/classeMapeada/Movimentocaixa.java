 ...
 */
@Entity
@Table(name = "MOVIMENTOCAIXA", catalog = "sgps", schema = "")
@NamedQueries({
...
public class Movimentocaixa implements Serializable {
    ...
    @Column(name = "IDMOVIMENTOCAIXA", nullable = false)
    private Integer idmovimentocaixa;
    @Basic(optional = false)
    @Column(name = "DATAHORAMOVCAIXA", nullable = false)
    @Temporal(TemporalType.TIMESTAMP)
    private Date datahoramovcaixa;
    @Column(name = "VALORABERTURACAIXAMOVCAIXA", precision = 11, scale = 2)
    private BigDecimal valoraberturacaixamovcaixa;
    @Column(name = "VALORSANGRIACAIXAMOVCAIXA", precision = 11, scale = 2)
    ...
    @Column(name = "VALORDINHEIROMOVCAIXA", precision = 11, scale = 2)
    private BigDecimal valordinheiromovcaixa;
    @Column(name = "VALORCHEQUEMOVCAIXA", precision = 11, scale = 2)
    private BigDecimal valorchequemovcaixa;
    @Column(name = "VALORCARTAOMOVCAIXA", precision = 11, scale = 2)
    private BigDecimal valorcartaomovcaixa;
    @Column(name = "VALORDUPLICATAMOVCAIXA", precision = 11, scale = 2)
    private BigDecimal valorduplicatamovcaixa;
    @Column(name = "VALORTOTALMOVCAIXA", precision = 11, scale = 2)
