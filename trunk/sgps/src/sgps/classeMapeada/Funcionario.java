 ...
 */
@Entity
@Table(name = "FUNCIONARIO", catalog = "sgps", schema = "")
@NamedQueries({
...
public class Funcionario implements Serializable {
    ...
    @Column(name = "IDPESSOAFUNCIONARIO", nullable = false)
    ...
    @Column(name = "COMISSAOFUNCIONARIO", precision = 4, scale = 2)
    ...
    @JoinColumn(name = "IDPESSOAFUNCIONARIO", referencedColumnName = "IDPESSOA", nullable = false, insertable = false, updatable = false)
