...
public class Produto implements Serializable {
    ...
    @Column(name = "COD_PRODUTO", nullable = false, length = 13)
    private String codProduto;
    @Column(name = "DESCRICAO_PRODUTO", length = 50)
    private String descricaoProduto;
    @Column(name = "VLR_COMPRA_PRODUTO", precision = 11, scale = 2)
    private Double vlrCompraProduto;
    @Column(name = "VLR_VENDA_PRODUTO", precision = 11, scale = 2)
    ...
    public String toString() {
        return "br.com.ClassesPersistentes.Produto[codProduto=" + codProduto + "]";
    }
